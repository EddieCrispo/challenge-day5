import { CreditCard, Eye, EyeOff, ArrowRight, Sparkles, User, Mail, Lock } from 'lucide-react';
import { useState } from 'react';
import { useNavigate } from 'react-router'


function RegisterPage({ onClick }) {
            ...
            <div className="relative w-full max-w-md mx-4">
                ...
                <div className="backdrop-blur-xl bg-white/10 border border-white/20 rounded-3xl p-6 shadow-2xl transform hover:scale-105 transition-all duration-500 hover:shadow-purple-500/25">
                    ...
                    <div className="text-center mb-5">
                        ...
                        <h1 className="text-3xl font-bold bg-gradient-to-r from-white via-purple-200 to-white bg-clip-text text-transparent mb-1 animate-pulse">
                            Join BankTech Pro
                        </h1>
                        <p className="text-white/70 text-sm">Create your account and start banking</p>
                    </div>
                    ...
                    <div className="space-y-4">
                        <form className='space-y-2'>
                            ...
                            <div className="grid grid-cols-2 gap-3">
                                <div className="space-y-1">
                                    <label className="block text-white/80 text-sm font-medium">First Name</label>
                                    <div className="relative group">
                                        <input
                                            ...
                                            className="w-full px-3 py-2 bg-white/10 border border-white/20 rounded-xl text-white placeholder-white/50 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent transition-all duration-300 hover:bg-white/15 backdrop-blur-sm text-sm"
                                            placeholder="John"
                                            required
                                        />
                                ...
                                <div className="space-y-1">
                                    <label className="block text-white/80 text-sm font-medium">Last Name</label>
                                    <div className="relative group">
                                        <input
                                            type="text"
                                            name="lastName"
                            ...
                            <div className="space-y-1">
                                ...
                                <div className="relative group">
                                    <input
                                        ...
                                        onChange={handleChange}
                                        className="w-full px-3 py-2 bg-white/10 border border-white/20 rounded-xl text-white placeholder-white/50 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent transition-all duration-300 hover:bg-white/15 backdrop-blur-sm"
                            ...
                            <div className="space-y-1">
                                ...
                                <div className="relative group">
                                    <input
                                        ...
                                        onChange={handleChange}
                                        className="w-full px-3 py-2 pr-10 bg-white/10 border border-white/20 rounded-xl text-white placeholder-white/50 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent transition-all duration-300 hover:bg-white/15 backdrop-blur-sm"
                            ...
                            <div className="flex items-start space-x-2">
                                ...
                                <label htmlFor="terms" className="text-white/70 text-sm">
                                    I agree to the{' '}
                                    <a href="#" className="text-purple-300 hover:text-white transition-colors duration-200 hover:underline">
                                        Terms of Service
                                    </a>
                                    {' '}and{' '}
                                    <a href="#" className="text-purple-300 hover:text-white transition-colors duration-200 hover:underline">
                        ...
                        {/* <div className="grid grid-cols-2 gap-3">
                            <button
                                type="button"
                                className="flex items-center justify-center px-3 py-2 bg-white/10 border border-white/20 rounded-xl text-white hover:bg-white/20 transition-all duration-300 hover:scale-105 backdrop-blur-sm"
                            >
